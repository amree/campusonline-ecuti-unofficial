 ...
 */
public class CutiDiambilAdapter extends BaseAdapter {

    Context context;
    ArrayList<CutiDiambilParcel> data;
    private static LayoutInflater inflater = null;

    public CutiDiambilAdapter(Context context, ArrayList<CutiDiambilParcel> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Get the data item
        CutiDiambilParcel item = data.get(position);
