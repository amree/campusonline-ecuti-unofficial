...
public class AwardWangTunaiFragment extends ListFragment {
    ...
    // TODO: Rename and change types of parameters
    public static AwardWangTunaiFragment newInstance(String param1, String param2) {
        AwardWangTunaiFragment fragment = new AwardWangTunaiFragment();
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (null != mListener) {
            ...
            mListener.onAwardWangTunaiFragmentInteraction(DummyContent.ITEMS.get(position).id);
        }
    }
